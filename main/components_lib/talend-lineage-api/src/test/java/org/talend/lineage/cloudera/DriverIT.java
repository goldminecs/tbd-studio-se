...
public class DriverIT {
    ...
    public static void main(String[] args) {
        ...
        LineageCreator lc = new LineageCreator("http://localhost", "http://quickstart.cloudera:7187/api/v12",
                "http://quickstart.cloudera:7187/api/v12/metadata/plugin", "admin", "admin", "Job007", "project003", true, false,
                12);
